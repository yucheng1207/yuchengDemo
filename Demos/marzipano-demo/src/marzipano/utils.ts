...
export function generateSourceFromTile(urlPrefix: string, isCustomFormat = true): MarzipanoImageUrlSourceFromTile {
...
export function createMultiresolutionSource(urlPrefix: string, isCustomFormat = true) {
	return createImageUrlSource(generateSourceFromTile(urlPrefix, isCustomFormat));
}
